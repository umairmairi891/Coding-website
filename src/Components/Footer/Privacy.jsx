    ...
    return (
        <div>
            <div className=" mx-3 md:mx-10 py-5">
                ...
                <div className="w-full p-5 " style={{ boxShadow: '0 4px 6px rgba(0,0,0,0.1), 0 3px 4px rgba(0,0,0,0.08)' }}>
                ...
                <div className="w-full p-5 mt-4" style={{ boxShadow: '0 4px 6px rgba(0,0,0,0.1), 0 3px 4px rgba(0,0,0,0.08)' }}>
