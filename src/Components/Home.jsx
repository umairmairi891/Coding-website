        ...
        <>
            <div className=" px-3 sm:px-10 py-10">
              ...
              <div className='grid grid-cols-1 sm:grid-cols-12 w-[100%] sm:w-full  mt-5 '>
                    <div className='bg-gray-600 p-3 w- sm:col-span-3 max-h-[510px] overflow-auto text-xl text-white font-[Roboto] rounded'>
                        <h2 className='font-bold px-2'>Languages</h2>
                        <input className='bg-white text-black rounded w-full px-3 py-2 mt-2' type="text" placeholder='Search Langauges' />
                        <h3 className='text-center mt-4 font-semibold hover:bg-blue-600 cursor-pointer rounded py-2'>Papular Languages</h3>
